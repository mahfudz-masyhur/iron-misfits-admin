...
const IconNotifcations = forwardRef<SVGSVGElement, IconProps>((props: IconProps, ref) => {
...
IconNotifcations.displayName = 'IconNotifcations'

export default IconNotifcations
